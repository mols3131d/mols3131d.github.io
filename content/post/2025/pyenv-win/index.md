...
Aliases:  
Description: Windows에서 Python 버전을 관리하는 도구. Linux나 macOS에서 사용하는 https://github.com/pyenv/pyenv의 Windows 버전. 
Tags: Computer Language :: Python, Computer Language :: Python :: 3, development environment, 도구 | Tools
Last Edited Date: 2025-12-30
...
| `pyenv rehash` | 심링크(Shim) 갱신 | - `pip`으로 라이브러리를 설치/삭제하거나 파일 변경 후 반드시 실행
- `.pyenv` 폴더 외부에서 실행해야 함 |
