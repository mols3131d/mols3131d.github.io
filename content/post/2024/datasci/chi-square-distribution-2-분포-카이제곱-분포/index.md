...
- **자유도**
  ...
  ![Chi-square distribution PDF](chi-square-pdf.png)

  Chi-square distribution PDF

  ![Chi-square distribution CDF](chi-square-cdf.png)
...
- [카이제곱 분포 (나무위키)](https://namu.wiki/w/%EC%B9%B4%EC%9D%B4%EC%A0%9C%EA%B3%B1%EB%B6%84%ED%8F%AC)
- [공돌이의 수학정리노트 - 카이제곱 분포](https://angeloyeo.github.io/2021/12/13/chi_square.html)
